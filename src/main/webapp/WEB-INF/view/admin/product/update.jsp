                ...
                <div class="mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <br>
                            <form:form modelAttribute="newProduct" method="post" action="/admin/product/edit">
                                <form:hidden path="id"/>
                                ...
                                <div class="mb-3">
                                    <label>Name</label>
                                    <input type="text" class="form-control" value="${newProduct.name}" readonly/>
                                </div>
                                <div class="mb-3">
                                    <label>Price</label>
                                    <input type="number" step="0.01" name="price" class="form-control" value="<fmt:formatNumber value='${newProduct.price}' groupingUsed='false'/>"/>
                                </div>
                                <div class="mb-3">
